...
namespace sprint0
{
    public class SpriteFactory
    {
        ...
        public ISprite Arrow(SpriteBatch spriteBatch, Vector2 position, Vector2 velocity)
        {
            return new Sprite(zeldaSpritesheet, new Rectangle[1], spriteBatch, position, velocity);
        }
    }
}
