...
namespace sprint0
{
    ...
    public class SpriteFactory
    {
        ...
        public void LoadTextures(ContentManager content, SpriteBatch spriteBatch)
        {
            ...
            font = content.Load<SpriteFont>("PixelEmulator");
        }
        ...
        public Sprite DungeonDoorNorth(Vector2 position)
        {
            ...
            return new Sprite(dungeonDoorNorth, rectangles, spriteBatch, position, Constants.BLOCK_LAYER_DEPTH);
        }
        ...
        public Sprite DungeonDoorSouth(Vector2 position)
        {
            ...
            return new Sprite(dungeonDoorSouth, rectangles, spriteBatch, position, Constants.BLOCK_LAYER_DEPTH);
        }
        ...
        public Sprite DungeonDoorEast(Vector2 position)
        {
            ...
            return new Sprite(dungeonDoorEast, rectangles, spriteBatch, position, Constants.BLOCK_LAYER_DEPTH);
        }
        ...
        public Sprite DungeonDoorWest(Vector2 position)
        {
            ...
            return new Sprite(dungeonDoorWest, rectangles, spriteBatch, position, Constants.BLOCK_LAYER_DEPTH);
        }
        ...
        public Sprite DungeonBadDoorNorth(Vector2 position)
        {
            ...
            return new Sprite(dungeonBadDoorNorth, rectangles, spriteBatch, position, Constants.BLOCK_LAYER_DEPTH);
        }
        ...
        public Sprite DungeonBadDoorSouth(Vector2 position)
        {
            ...
            return new Sprite(dungeonBadDoorSouth, rectangles, spriteBatch, position, Constants.BLOCK_LAYER_DEPTH);
        }
        ...
        public Sprite DungeonSand(Vector2 position)
        {
            ...
            return new Sprite(dungeonSand, rectangles, spriteBatch, position, Constants.BLOCK_LAYER_DEPTH);
        }
        ...
        public Sprite DungeonAbyss(Vector2 position)
        {
            ...
            return new Sprite(dungeonAbyss, rectangles, spriteBatch, position, Constants.BLOCK_LAYER_DEPTH);
        }
        ...
        public Sprite DungeonStairs(Vector2 position)
        {
            ...
            return new Sprite(dungeonStairs, rectangles, spriteBatch, position, Constants.BLOCK_LAYER_DEPTH);
        }
        ...
        public Sprite WaterBlock(Vector2 position)
        {
            ...
            return new Sprite(waterBlock, rectangles, spriteBatch, position, Constants.BLOCK_LAYER_DEPTH);
        }
        ...
        {
            return new Sprite(Bomb, ItemRectangle.Bomb, spriteBatch, position, Constants.ITEM_LAYER_DEPTH);
        }

        public Sprite ZeldaBoomerang(Vector2 position)
        {
            return new Sprite(Boomerang, ItemRectangle.Boomerang, spriteBatch, position, Constants.ITEM_LAYER_DEPTH);
        }
        ...
        public TextSprite Number(Vector2 position, int number, Color color)
        {
            string text = "x" + number.ToString();
            return new TextSprite(spriteBatch, position, font, text, color);
        }

        public TextSprite Text(Vector2 position, string text, Color color)
        {
            return new TextSprite(spriteBatch, position, font, text, color);
        }
    }
