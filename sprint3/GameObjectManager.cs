...
namespace sprint0
{
    public class GameObjectManager : IUpdateable, IDrawable
    {
        ...
        {
            enemy.Velocity = new Vector2(-(float)enemy.Velocity.X, (float)enemy.Velocity.Y);
        }
        ...
        {
            player.Velocity = new Vector2(player.Velocity.X-player.Velocity.X, player.Velocity.Y);
        }
